<template>
  <div class="mx-auto min-w-[300px] max-w-5xl px-4 sm:px-6 lg:px-8">
    ...
    <div class="relative">
      ...
      <div class="absolute inset-y-0 left-0 flex items-center pl-[1px]">
        <div class="relative w-40">
          <Listbox v-model="selectedPlatform">
            <ListboxButton
              class="relative w-full cursor-default rounded-md bg-background-light py-2 pl-3 pr-10 text-left shadow-md focus:outline-none focus-visible:border-indigo-500 focus-visible:ring-2 focus-visible:ring-white/75 focus-visible:ring-offset-2 focus-visible:ring-offset-orange-300"
            >
            ...
            >
              <ListboxOptions
                class="absolute mt-1 max-h-60 w-full overflow-auto rounded-md bg-background-light py-1 text-base shadow-lg ring-1 ring-black/5 focus:outline-none"
              >
                <ListboxOption
      ...
      <input
        v-model="searchText"
        @keyup.enter="search"
        class="ark:focus:ring-slate-300 block w-full rounded-md border border-white/40 bg-background-light/5 py-2 pl-52 pr-3 leading-5 text-white placeholder-light focus:border-light focus:bg-background-light focus:text-white focus:placeholder-gray-500 focus:outline-none focus:ring-light"
